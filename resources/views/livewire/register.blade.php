            ...
            <div class="bg-gray-50 py-16 px-4 sm:px-6 lg:col-span-2 lg:px-8 lg:py-24 xl:pr-12">
                <div class="max-w-lg mx-auto">
                    ...
                    <p class="mt-6 text-base leading-6 text-gray-500">
                        Want to get sharp?
                        <a href="#" class="font-medium text-gray-700 underline">View all programs</a>.
                    </p>
                </div>
            </div>
            <div class="bg-white py-16 px-4 sm:px-6 lg:col-span-3 lg:py-24 lg:px-8 xl:pl-12">
                <div class="max-w-lg mx-auto lg:max-w-none">
                    <form wire:submit.prevent="submitForm" action="{{ route('register') }}" method="POST" class="grid grid-cols-1 row-gap-6">
                        @csrf
                        ...
                        <div>
                            ...
                            <div class="relative rounded-md shadow-sm">
                                <select wire:model="role" id="role" name="role" value="{{ old('role') }}"
                                        class="@error('role')border border-red-500 @enderror form-input block w-full py-3 px-4 transition ease-in-out duration-150 text-gray-500">
                        ...
                        <div>
                            ...
                            <div class="relative rounded-md shadow-sm">
                                <input type="password" wire:model="password" id="password" name="password"
                                       class="@error('password')border border-red-500 @enderror form-input block w-full py-3 px-4 placeholder-gray-500 transition ease-in-out duration-150"
                        ...
                        <div>
                            ...
                            <div class="relative rounded-md shadow-sm">
                                <input type="password" wire:model="password_confirmation" id="confirm-password" name="password_confirmation"
                                       class="@error('confirm-password')border border-red-500 @enderror form-input block w-full py-3 px-4 placeholder-gray-500 transition ease-in-out duration-150"
                                       placeholder="Confirm Password">{{ old('confirm-password') }}
                            </div>
